    ...
    return (
        <ul className="list-none">
            {results.map((result, index) => {
                // Memoize the URL creation to avoid regenerating it on each render
                            ...
                            <div className="md:w-1/2 w-full p-2 flex justify-center items-center relative">
                                ...
                                {imageURL && (
                                    <img
                                        ...
                                        className={`w-full h-auto rounded-lg transition-opacity duration-300 ${isLoading ? 'opacity-0' : 'opacity-100'}`}
