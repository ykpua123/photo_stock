...
const EntryAnalyzer = () => {
    ...
    const analyzeText = () => {
        ...
        // Set analyzed results (do not save to DB here)
    ...
    const saveResults = async (results: Entry[]) => {
        // Check if any result is missing an image before saving
        //const missingImages = results.some(result => !result.image);
    
        // if (missingImages) {
        //     alert("Warning: Entries without image, please delete before saving.");
        //     return;
        // }
